  ...
  return (
    <div className="bg-slate-600 ">
      <div className="flex p-5 bg-slate-500 items-center">
        ...
        <div className="flex ml-auto p-6 bg-white rounded-lg px-3 py-1 items-center">
          <FaSearch className="text-black" />
          <input
            className="bg-transparent border-none h-full w-full focus:outline-none ml-5 text-black"
            type="text"
